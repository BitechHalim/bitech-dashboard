  ...
  return (
    <Card>
      ...
      <CardContent>
        <div className="space-y-4">
          {chartData.map((data, index) => (
            <div
              key={index}
              className="space-y-1 group transition-all hover:scale-[1.01]"
            >
              ...
              <div className="relative w-full h-4 bg-muted rounded">
                <div
                  className="absolute h-4 bg-primary rounded transition-all group-hover:bg-secondary-foreground"
      ...
      <CardFooter className="flex-col items-start gap-2 text-sm">
        <div className="flex gap-2 font-medium leading-none group transition-transform hover:scale-[1.05]">
