    ...
    <div className="flex min-h-[80vh] flex-col items-center justify-center bg-background p-4">
      <div className="flex max-w-md flex-col items-center space-y-6 text-center">
        <div className="relative">
          <BarChart2 className="h-20 w-20 text-muted-foreground" />
          <div className="absolute right-0 top-0 rounded-full bg-destructive p-1 text-destructive-foreground">
            <span className="text-xl font-bold">!</span>
          </div>
        </div>

        <h1 className="text-3xl font-bold tracking-tight">Analytics Error</h1>

        <h2 className="text-xl font-semibold text-muted-foreground">
          {error.digest ? `Error ID: ${error.digest}` : 'Data processing error'}
        </h2>

        <p className="text-muted-foreground">
          We're having trouble loading your analytics data. This could be due to
          a data processing issue or temporary service disruption.
        </p>
